		...
		<div class="d-flex flex-column-reverse flex-lg-row">			
			...
			<div class="pt-lg-5 px-lg-5">
				...
				<div class="p-5 visitanos">
					...
					<p>SUITES CAMINO REAL, LA PAZ</p>

					<p>
					Calacoto Av. Ballivián #369<br>
					esquina Calle 10, La Paz.<br>
					Tel: (+591) 2279 2323<br>
					WhatsApp: (+591) 76765709
					</p>
			
					<p class="pb-lg-5">Email: suites@caminoreal.com.bo<br>
					</p>
