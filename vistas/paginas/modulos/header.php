			...
			<div class="row">
				...
				<div class="col-7 col-sm-5 col-md-4 col-lg-2 col-xl-3 my-3 d-flex mt-lg-3 logotipo">
					...
					<a href="<?php echo $ruta; ?>inicio">
						<img data-nite-src="img/logo3.png" class="img-fluid pt-1 " width="100px" height="150px">
					</a>
				...
				<div class="d-none d-lg-block col-lg-8 col-xl-6 p-0 pt-lg-2 mt-lg-1 pt-xl-4 botonera">
					...
					<ul class="nav justify-content-lg-left justify-content-xl-end">
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="#cursos">SUITES</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#nosotros">PLANES</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#testimonios">GALERIA</a>
						</li>

						<li class="nav-item">
							<a class="nav-link text-white" href="#planes">EVENTOS</a>
						</li>
